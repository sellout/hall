...
This is especially helpful with [hpack-dhall](https://github.com/cabalism/hpack-dhall) or [dhall-to-cabal](https://github.com/dhall-lang/dhall-to-cabal), but the types and functions here are general enough to be used whenever you work with Haskell from Dhall.
